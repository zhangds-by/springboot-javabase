...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"t_hero"});// 需要生成的表
...
//        mpg.setTemplate(templateConfig);
        ...
        pc.setParent("com.zhangds.pool.mybatisplus");
