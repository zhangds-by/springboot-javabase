package com.zhangds.pool.config.member;
...
@Configuration
@ComponentScan(basePackages = {"com.zhangds.pool.entities.member"})
@MapperScan(value = "com.zhangds.pool.mapper.member",sqlSessionTemplateRef = "memberSqlSessionTemplate")
public class MemberDatasourceConfig {

    private Logger log = LoggerFactory.getLogger(MemberDatasourceConfig.class);
    ...
    public DataSource memberDataSource(MemberConfig memberConfig) throws SQLException {
        log.info("member数据源" + memberConfig);
    ...
    public SqlSessionFactory memberSqlSessionFactory(@Qualifier("memberDataSource") DataSource dataSource) throws Exception {
        ...
        Resource[] mapperLocations = new PathMatchingResourcePatternResolver().getResources("classpath*:/mapper/xml/member/*.xml");
