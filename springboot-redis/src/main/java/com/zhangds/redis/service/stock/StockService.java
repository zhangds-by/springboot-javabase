package com.zhangds.redis.service.stock;

import com.zhangds.redis.lock.IStockCallback;
import com.zhangds.redis.lock.impl.RedisLock;
...
public class StockService {
    ...
    public static final long UNINITIALIZED_STOCK = -3L; // 不限库存

    public static final String STOCK_LUA; //执行扣库存的脚本
